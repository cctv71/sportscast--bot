...
# ---------------------------------------------------------------------------
LEAGUE_TV_TABLE = {
    # UK broadcasters only — fallback shown when TheSportsDB API has no TV data.
    # These are the real UK multi-year broadcast deals from TheSportsDB league pages.
    # Motorsport
    '4407': [('UK', 'TNT Sports'), ('UK', 'itv')],                     # MotoGP
    '4370': [('UK', 'Sky Sports F1'), ('UK', 'Channel 4')],            # Formula 1
    '4371': [('UK', 'TNT Sports'), ('UK', 'Quest')],                   # Formula E
    '4409': [('UK', 'Rally.TV')],                                      # WRC
    '4376': [('UK', 'Viaplay')],                                       # NASCAR
    '4373': [('UK', 'Sky Sports F1')],                                 # IndyCar
    '4374': [('UK', 'itv4'), ('UK', 'itvX')],                          # BTCC
    '4375': [('UK', 'TNT Sports'), ('UK', 'Quest')],                   # British Superbikes
    '4379': [('UK', 'TNT Sports')],                                    # Dakar Rally
    # Golf
    '4425': [('UK', 'Sky Sports Golf')],                               # PGA Tour
    '4426': [('UK', 'Sky Sports Golf')],                               # DP World Tour
    '4753': [('UK', 'itv')],                                           # LIV Golf
    '4422': [('UK', 'Sky Sports Golf')],                               # LPGA Tour
    # Darts / Snooker
    '4554': [('UK', 'Sky Sports'), ('UK', 'itv4')],                    # PDC Darts
    '4555': [('UK', 'BBC'), ('UK', 'TNT Sports'), ('UK', 'Eurosport')],# World Snooker
    # Tennis
    '4489': [('UK', 'Sky Sports Tennis')],                             # ATP
    '4490': [('UK', 'Sky Sports Tennis')],                             # WTA
    '4498': [('UK', 'Eurosport'), ('UK', 'discovery+')],               # Australian Open
    '4499': [('UK', 'TNT Sports'), ('UK', 'Eurosport')],               # French Open
    '4500': [('UK', 'BBC'), ('UK', 'TNT Sports')],                     # Wimbledon
    '4501': [('UK', 'Sky Sports Tennis')],                             # US Open
    # Combat
    '4445': [('UK', 'DAZN'), ('UK', 'Sky Sports Boxing'), ('UK', 'TNT Sports')],  # Boxing
    '4443': [('UK', 'TNT Sports')],                                    # UFC
    '4449': [('UK', 'Netflix')],                                       # WWE
}
